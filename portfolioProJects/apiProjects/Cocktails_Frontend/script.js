...
$('button').on('click', ()=>{
    ...
    .then(data => {
        ...
        // * declare all your variables with the first drink data in the drinks array
        // * this is how we can declare an array of variables
        let {strDrink, strDrinkThumb, strInstructions} = data.drinks[0]
        console.log(`this is data.drinks[0]: ${data.drinks[0].strDrink}`)
